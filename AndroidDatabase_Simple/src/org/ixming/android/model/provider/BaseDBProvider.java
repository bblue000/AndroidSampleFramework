 ...
 * it doesn't support Uri like “content://xxx/#/xxx/#”
 */
public abstract class BaseDBProvider extends ContentProvider {
	...
	private static final String SELECTION_BY_ID = BaseColumns._ID + " = ? ";
	
	/** create a new subclass of SQLiteOpenHelper, this is only called in onCreate()*/
	protected abstract SQLiteOpenHelper createSQLiteOpenHelper(Context context);
	/** get the database authority*/
	protected abstract String getAuthority();
	
	private static final int URI_MATCHER_TABLE = 0;
	private static final int URI_MATCHER_ID = 1;
