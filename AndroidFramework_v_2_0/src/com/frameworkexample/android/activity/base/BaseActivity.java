 ...
 * 
 * <p>
 * 根据Activity的生命周期，在onCreate阶段细分步骤：
 * <ul>
 * <li>{@link #initView(View)}</li>
 * <li>{@link #initListener()}</li>
 * <li>{@link #initData(View, Bundle)}</li>
 * </ul>
 * </p>
 * 
 * @author Yin Yong
...
public abstract class BaseActivity extends Activity implements OnClickListener {
	 ...
	 */
	protected BaseActivity bindClickListener(int resId) {
	 ...
	 * @see 推荐使用{@link org.ixming.android.inject.InjectorUtils}
	 */
	protected BaseActivity bindClickListener(View view) {
		if (null != view) {
	 ...
	 */
	protected BaseActivity removeClickListener(int resId) {
	 ...
	 * 移除View的单击事件监听器
	 */
	protected BaseActivity removeClickListener(View view) {
		if (null != view) {
